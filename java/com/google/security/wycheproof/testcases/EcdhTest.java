 ...
 * Testing ECDH.
 *
 * <p><b>Defense in depth</b>: The tests for ECDH assume that a attacker has
 * control over all aspects of the public key in an exchange. That means that
 * the attacker can potentially send weak or invalid public keys. For example,
 * invalid public keys can contain points not on the curve, curves that have
 * been deliberately chosen so that DLs are easy to compute as well as orders or
 * cofactors that are wrong. It is expected that implementations validate the
 * inputs of a key agreement and that in no case information about the private
 * key is leaked.
 *
 * <p><b>References:</b> Ingrid Biehl, Bernd Meyer, Volker Müller, "Differential
 * Fault Attacks on Elliptic Curve Cryptosystems", Crypto '00, pp. 131-164
 *
 * <p>Adrian Antipa, Daniel Brown, Alfred Menezes, Rene Struik, and Scott
 * Vanstone, "Validation of Elliptic Curve Public Keys", PKC 2003,
 * https://www.iacr.org/archive/pkc2003/25670211/25670211.pdf
 *
 * <p><b>Bugs:</b> CVE-2015-7940: BouncyCastle before 1.51 does not validate a
 * point is on the curve. BouncyCastle v.1.52 checks that the public key point
 * is on the public key curve but does not check whether public key and private
 * key use the same curve. BouncyCastle v.1.53 is still vulnerable to attacks
 * with modified public keys. An attacker can change the order of the curve used
 * by the public key. ECDHC would then reduce the private key modulo this order,
 * which can be used to find the private key.
 *
 * <p>CVE-2015-6924: Utimaco HSMs vulnerable to invalid curve attacks, which
 * made the private key extraction possible.
 *
 * <p>CVE-2015-7940: Issue with elliptic curve addition in mixed Jacobian-affine
 * coordinates
 *
...
//     java.lang.UnsupportedOperationException: KDF can only be used when
//     algorithm is known Not sure if that is expected or another bug.
// CVEs for ECDH we haven't used anywhere.
//   - CVE-2014-3470: OpenSSL anonymous ECDH denial of service: triggered by
//   NULL value in
//     certificate.
...
public class EcdhTest {
  ...
  static final String[] ECDH_VARIANTS = {
      // Raw ECDH. The shared secret is the x-coordinate of the ECDH
      // computation.
  ...
  public static class EcPublicKeyTestVector {
    ...
    public EcPublicKeyTestVector(String comment, String encoded, BigInteger p,
                                 BigInteger n, BigInteger a, BigInteger b,
                                 BigInteger gx, BigInteger gy, Integer h,
                                 BigInteger pubx, BigInteger puby) {
    ...
    /**
     * Returns this key as ECPublicKeySpec or null if the key cannot be
     * represented as ECPublicKeySpec. The later happens for example if the
     * order of cofactor are not positive.
     */
  ...
  public static final EcPublicKeyTestVector EC_VALID_PUBLIC_KEY =
      new EcPublicKeyTestVector(
          ...
          1,
          new BigInteger(
              "cdeb39edd03e2b1a11a5e134ec99d5f25f21673d403f3ecb47bd1fa676638958",
              16),
          new BigInteger(
              "ea58493b8429598c0b49bbb85c3303ddb1553c3b761c2caacca71606ba9ebac8",
              16));
  ...
  public static final EcPublicKeyTestVector[] EC_MODIFIED_PUBLIC_KEYS = {
      ...
      new EcPublicKeyTestVector(
          ...
          new BigInteger(
              ...
              16),
          new BigInteger(
              "ea58493b8429598c0b49bbb85c3303ddb1553c3b761c2caacca71606ba9ebaca",
              16)),
      new EcPublicKeyTestVector(
          "public point = (0,0)",
          ...
          new BigInteger(
              "4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5",
              16),
          1, new BigInteger("0"), new BigInteger("0")),
      new EcPublicKeyTestVector(
          "order = 1",
      ...
      new EcPublicKeyTestVector(
          ...
          new BigInteger(
              ...
              16),
          new BigInteger(
              "ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2", 16),
          new BigInteger(
              "ffffffff00000001000000000000000000000000fffffffffffffffffffffffc",
              16),
          new BigInteger(
      ...
      new EcPublicKeyTestVector(
          ...
          new BigInteger(
              "5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b",
              16),
          new BigInteger("0"), new BigInteger("0"), 1,
          new BigInteger(
              "cdeb39edd03e2b1a11a5e134ec99d5f25f21673d403f3ecb47bd1fa676638958",
              16),
          new BigInteger(
      ...
      new EcPublicKeyTestVector(
          ...
          new BigInteger(
              ...
              16),
          new BigInteger(
              "4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f7",
              16),
          1,
          new BigInteger(
              "cdeb39edd03e2b1a11a5e134ec99d5f25f21673d403f3ecb47bd1fa676638958",
      ...
      new EcPublicKeyTestVector(
          ...
          new BigInteger(
              "fd091059a6893635f900e9449d63f572b2aebc4cff7b4e5e33f1b200e8bbc145",
              16),
          new BigInteger(
              "ffffffff00000000ffffffffffffffffbce6faada7179e84f3b9cac2fc632551",
              16),
          ...
          new BigInteger(
              "1b8c7dd77f9a95627922eceefea73f028f1ec95ba9b8fa95a3ad24bdf9fff414",
              16),
          1, new BigInteger("06597fa94b1fd9000000000000000000000000000002", 16),
          new BigInteger(
              "1b8c7dd77f9a95627922eceefea73f028f1ec95ba9b8fa95a3ad24bdf9fff414",
              16)),
      new EcPublicKeyTestVector(
          ...
          1,
          new BigInteger(
              "074f56dc2ea648ef89c3b72e23bbd2da36f60243e4d2067b70604af1", 16),
          new BigInteger(
              "c2165cec2f86603d60c8a611d5b84ba3d91dfe1a480825bcc4af3bcf", 16)),
      new EcPublicKeyTestVector(
          "a = 0",
          ...
          new BigInteger("0"),
          new BigInteger(
              "f104880c3980129c7efa19b6b0cb04e547b8d0fc0b95f4946496dd4ac4a7c440",
              16),
          new BigInteger(
              "cdeb39edd03e2b1a11a5e134ec99d5f25f21673d403f3ecb47bd1fa676638958",
              16),
      ...
      new EcPublicKeyTestVector(
          ...
          new BigInteger(
              ...
              16),
          new BigInteger(
              "46dc879a5c2995d0e6f682468ea95791b7bbd0225cfdb2513fb10a737afece17",
              16),
          new BigInteger(
              "bea6c109251bfe4acf2eeda7c24c4ab70a1473335dec28b244d4d823d15935e2",
              16),
          new BigInteger(
              "701c05255026aa4630b78fc6b769e388059ab1443cbdd1f8348bedc3be589dc3",
              16),
          new BigInteger(
              "4cfdab998ad27738ae382aa013986ade0f48592a9a1ae37ca61d25ec5356f1bd",
              16),
          1,
          new BigInteger(
              "701c05255026aa4630b78fc6b769e388059ab1443cbdd1f8348bedc3be589dc3",
              16),
          new BigInteger(
              "b3025465752d88c851c7d55fec679521f0b7a6d665e51c8359e2da13aca90e42",
              16)),
      // Invalid keys
      new EcPublicKeyTestVector(
  ...
  @NoPresubmitTest(providers = {ProviderType.BOUNCY_CASTLE},
                   bugs = {"BouncyCastle uses long encoding. Is this a bug?"})
  @Test
  public void
  testEncode() throws Exception {
    KeyFactory kf = KeyFactory.getInstance("EC");
    ECPublicKey valid =
        (ECPublicKey)kf.generatePublic(EC_VALID_PUBLIC_KEY.getSpec());
    assertEquals(TestUtil.bytesToHex(valid.getEncoded()),
                 EC_VALID_PUBLIC_KEY.encoded);
  }
  ...
  public void testDecode() throws Exception {
    ...
    ECPublicKey key1 =
        (ECPublicKey)kf.generatePublic(EC_VALID_PUBLIC_KEY.getSpec());
    ECPublicKey key2 = (ECPublicKey)kf.generatePublic(
        EC_VALID_PUBLIC_KEY.getX509EncodedKeySpec());
  ...
  /**
   * This test modifies the order of group in the public key. A severe bug would
   * be an implementation that leaks information whether the private key is
   * larger than the order given in the public key. Also a severe bug would be
   * to reduce the private key modulo the order given in the public key
   * parameters.
   */
  ...
  public void testModifiedPublic(String algorithm) throws Exception {
    ...
    for (EcPublicKeyTestVector test : EC_MODIFIED_PUBLIC_KEYS) {
      try {
        ...
        // in the public key. An attacker who can modify the order of the public
        // key and who can learn whether such a modification changes the shared
        // secret is able to learn the private key with a simple binary search.
        assertEquals("algorithm:" + algorithm + " test:" + test.comment,
                     expected, shared);
      } catch (GeneralSecurityException ex) {
        // OK, since the public keys have been modified.
        System.out.println("testModifiedPublic:" + test.comment + " throws " +
                           ex.toString());
      }
    }
  }
  ...
  /**
   * This is a similar test as testModifiedPublic. However, this test uses test
   * vectors ECPublicKeySpec
   */
  @SuppressWarnings("InsecureCryptoUsage")
  public void testModifiedPublicSpec(String algorithm) throws Exception {
    ...
    for (EcPublicKeyTestVector test : EC_MODIFIED_PUBLIC_KEYS) {
      ...
      if (spec == null) {
        // The constructor of EcPublicKeySpec performs some very minor validity
        // checks. spec == null if one of these validity checks fails. Of course
        // such a failure is OK.
        continue;
      }
      try {
        ECPublicKey modifiedKey = (ECPublicKey)kf.generatePublic(spec);
  ...
  @SuppressWarnings("InsecureCryptoUsage")
  public void testDistinctCurves(String algorithm, ECPrivateKey priv,
    ...
    // E.g., if the generated secret is the same as the x-coordinate of the
    // public key then it is likely that the ECDH computation was using a fake
    // group with small order. Such a situation is probably exploitable. This
    // probably is exploitable. If the curve of the private key was used for the
    // ECDH then the generated secret and the x-coordinate of the public key are
    // likely distinct.
    ...
    System.out.println("Private key: a=" + privCurve.getA() + " b=" +
                       privCurve.getB() + " p" + EcUtil.getModulus(privCurve));
    System.out.println("        s =" + priv.getS());
    System.out.println("Public key: a=" + pubCurve.getA() + " b=" +
                       pubCurve.getB() + " p" + EcUtil.getModulus(pubCurve));
    System.out.println("        w = (" + pubW.getAffineX() + ", " +
                       pubW.getAffineY() + ")");
    System.out.println("          = (" + pubW.getAffineX().toString(16) + ", " +
   ...
   * parameters.
   */
  // TODO(bleichen): This can be merged with testModifiedPublic once this is
  // fixed.
  @SuppressWarnings("InsecureCryptoUsage")
  public void testWrongOrder(String algorithm, ECParameterSpec spec)
    ...
    ECParameterSpec modifiedParams =
        new ECParameterSpec(spec.getCurve(), spec.getGenerator(),
                            spec.getOrder().shiftRight(16), 1);
    ECPublicKeySpec modifiedPubSpec =
        new ECPublicKeySpec(pub.getW(), modifiedParams);
    KeyFactory kf = KeyFactory.getInstance("EC");
    ECPublicKey modifiedPub;
    try {
      modifiedPub = (ECPublicKey)kf.generatePublic(modifiedPubSpec);
    } catch (GeneralSecurityException ex) {
      // The provider does not support non-standard curves or did a validity
      // check. Both would be correct.
    ...
    // TODO(bleichen): Getting here is already a bug and we might flag this
    // later. At the moment we are only interested in really bad behavior of a
    // library, that potentially leaks the secret key. This is the case when the
    // shared secrets are different, since this suggests that the implementation
    // reduces the multiplier modulo the given order of the curve or some other
    // behaviour that is dependent on the private key. An attacker who can check
    // whether a DH computation was done correctly or incorrectly because of
    // modular reduction, can determine the private key, either by a binary
    // search or by trying to guess the private key modulo some small "order".
    // BouncyCastle v.1.53 fails this test, and leaks the private key.
    System.out.println(
        "Generated shared secret with a modified order:" + algorithm + "\n"
        + "expected:" + TestUtil.bytesToHex(shared) +
        " computed:" + TestUtil.bytesToHex(shared2));
    assertEquals("Algorithm:" + algorithm, TestUtil.bytesToHex(shared),
   ...
   *
   * <p>Some libraries do not compute P + (-P) correctly and return 2 * P or
   * throw exceptions. When the library uses addition-subtraction chains for the
   * point multiplication then such cases can occur for example when the private
   * key is close to the order of the curve.
   */
  private void testLargePrivateKey(ECParameterSpec spec) throws Exception {
    ...
    for (int i = 1; i <= 64; i++) {
      ...
      // The private keys p1 and p2 are equivalent, since only the x-coordinate
      // of the shared point is used to generate the shared secret.
  ...
  /**
   * This test tries to determine whether point multipliplication using two
   * distinct points leads to distinguishable timings.
   *
   * The main goal here is to determine if the attack by Toru Akishita and
   * Tsuyoshi Takagi in
   * https://www-old.cdc.informatik.tu-darmstadt.de/reports/TR/TI-03-01.zvp.pdf
   * might be applicable. I.e. one of the points contains a zero value when
   * multiplied by mul, the other one does not.
   *
   ...
   * (3) The number of samples is rather low. Running this test with a larger
   * sample size would detect more timing differences. Unfortunately (4) The
   * test does not determine if a variable run time is exploitable. For example
   *     if the tested provider uses windowed exponentiation and the special
   * point is in the precomputation table then timing differences are easy to
   * spot, but more difficult to exploit and hence additional experiments would
   * be necessary.
   *
   ...
   * @param mul an integer, such that multiplying p0 with this value may lead to
   *     a timing
   *        difference
  ...
  private void testTiming(ECParameterSpec spec, ECPoint p0, ECPoint p1,
                          BigInteger mul, int privKeySize, String comment)
      throws Exception {
    ...
    //   4096, 1845
    //  10000, 4682
    // I.e. these are values, such that doing 'tests' coin flips results in <=
    // minCount heads or tails with a probability smaller than 2^-32.
    //
    ...
    for (int i = 0; i < 2; i++) {
      ...
      System.out.println("Timing for point " + i + " avg: " + avg[i] +
                         " std dev: " + stdDev + " cv:" + cv);
      // The ratio 0.05 below is a somewhat arbitrary value that tries to
      // determine if the noise is too big to detect even larger timing
      // differences.
      if (cv > 0.05) {
        noisy = true;
      }
    ...
    // Paired Z-test:
    // The outcome of this value can be significantly influenced by extreme
    // outliers, such as slow timings because of things like a garbage
    // collection.
    double sigmas =
        Math.abs(avg[0] - avg[1]) / Math.sqrt((var[0] + var[1]) / tests);
    System.out.println("Sigmas: " + sigmas);

    // Pairwise comparison:
    // this comparison has the property that it compares timings done with the
    // same private key, hence timing differences from using different addition
    // chain sizes are ignored. Extreme outliers should not influence the result
    // a lot, as long as the number of outliers is small.
    int point0Faster = 0;
    int equal = 0;
    for (int i = 0; i < sampleSize; i++) {
  ...
  @Test
  public void
  testTimingSecp256r1() throws Exception {
    // edge case for projective coordinates
    BigInteger x1 = new BigInteger(
        "81bfb55b010b1bdf08b8d9d8590087aa278e28febff3b05632eeff09011c5579", 16);
    BigInteger y1 = new BigInteger(
        "732d0e65267ea28b7af8cfcb148936c2af8664cbb4f04e188148a1457400c2a7", 16);
    ECPoint p1 = new ECPoint(x1, y1);
    // random point
    BigInteger x2 = new BigInteger(
        "8608e36a91f1fba12e4074972af446176b5608c9c58dc318bd0742754c3dcee7", 16);
    BigInteger y2 = new BigInteger(
        "bc2c9ecd44af916ca58d9e3ef1257f698d350ef486eb86137fe69a7375bcc191", 16);
    ECPoint p2 = new ECPoint(x2, y2);
    testTiming(EcUtil.getNistP256Params(), p1, p2, new BigInteger("2"), 256,
               "secp256r1");
  }
  ...
  @Test
  public void
  testTimingSecp384r1() throws Exception {
    // edge case for projective coordinates
    BigInteger x1 = new BigInteger(
        "7a6fadfee03eb09554f2a04fe08300aca88bb3a46e8f6347bace672cfe427698"
            + "8541cef8dc10536a84580215f5f90a3b",
        16);
    BigInteger y1 = new BigInteger(
        "6d243d5d9de1cdddd04cbeabdc7a0f6c244391f7cb2d5738fe13c334add4b458"
            + "5fef61ffd446db33b39402278713ae78",
        16);
    ECPoint p1 = new ECPoint(x1, y1);
    // random point
    BigInteger x2 = new BigInteger(
        "71f3c57d6a879889e582af2c7c5444b0eb6ba95d88365b21ca9549475273ecdd"
            + "3930aa0bebbd1cf084e4049667278602",
        16);
    BigInteger y2 = new BigInteger(
        "9dcbc4d843af8944eb4ba018d369b351a9ea0f7b9e3561df2ee218d54e198f7c"
            + "837a3abaa41dffd2d2cb771a7599ed9e",
        16);
    ECPoint p2 = new ECPoint(x2, y2);
    testTiming(EcUtil.getNistP384Params(), p1, p2, new BigInteger("2"), 384,
               "secp384r1");
  }
  ...
  @Test
  public void
  testTimingBrainpoolP256r1() throws Exception {
    // edge case for Jacobian and projective coordinates
    BigInteger x1 = new BigInteger(
        "79838c22d2b8dc9af2e6cf56f8826dc3dfe10fcb17b6aaaf551ee52bef12f826", 16);
    BigInteger y1 = new BigInteger(
        "1e2ed3d453088c8552c6feecf898667bc1e15905002edec6b269feb7bea09d5b", 16);
    ECPoint p1 = new ECPoint(x1, y1);

    // random point
    BigInteger x2 = new BigInteger(
        "2720b2e821b2ac8209b573bca755a68821e1e09deb580666702570dd527dd4c1", 16);
    BigInteger y2 = new BigInteger(
        "25cdd610243c7e693fad7bd69b43ae3e63e94317c4c6b717d9c8bc3be8c996fb", 16);
    ECPoint p2 = new ECPoint(x2, y2);
    testTiming(EcUtil.getBrainpoolP256r1Params(), p1, p2, new BigInteger("2"),
               255, "brainpoolP256r1");
  }
}
